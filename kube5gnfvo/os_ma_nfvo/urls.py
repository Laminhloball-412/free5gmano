...
slice_autoscaler = [path('', include('SliceAutoscaler.urls'))]
...
slice_autoscaler_schema_view = get_schema_view(
    openapi.Info(
        title="Dynamic Slice Autoscaler Interface",
        default_version='v1',
        description="Dynamic Network Slice management - automatic scaling and healing "
                    "of Network Slices based on real-time Kubernetes metrics.",
        terms_of_service="https://github.com/free5gmano/kube5gnfvo",
        contact=openapi.Contact(email="free5gmano@gmail.com"),
        license=openapi.License(name="BSD License"),
    ),
...
urlpatterns = [
    url(r'^swagger/v1/slice_autoscaler/$', slice_autoscaler_schema_view.with_ui('swagger', cache_timeout=0),
        name='schema-swagger-ui-slice'),
